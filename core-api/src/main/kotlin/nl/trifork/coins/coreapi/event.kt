...
data class OrderExecutedEvent(@TargetAggregateIdentifier val orderId: String, val userId: String, val fromCurrency: CoinType, val toCurrency: CoinType, val amount: BigDecimal, val price: BigDecimal)
...
data class LedgerMutatedEvent(@TargetAggregateIdentifier val userId: String, val orderId : String, val assets: Map<CoinType, BigDecimal>)